...
@click.option("--train-data", type=click.Path(exists=True, file_okay=True, dir_okay=True),
...
def main(train_data: str, random_seed: int, colsample_bytree: float, subsample: float):
    """Main Training Loop"""
